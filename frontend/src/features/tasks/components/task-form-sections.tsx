...
import type { ClassItem, RubricListItem, TaskCreateInput } from '@/service/api/v2/types';
import {
...
function TaskUnitRubricSection({ formData, setFormData, rubrics }: SectionProps) {
  return (
    <div className="grid grid-cols-2 gap-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => setFormData((prev) => ({ ...prev, unit_id_unit: e.target.value }))}
          required
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) =>
            setFormData((prev) => ({ ...prev, task_due_datetime: new Date(e.target.value).toISOString() }))
          }
          required
        />
      </div>
