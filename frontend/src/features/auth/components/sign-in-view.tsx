    ...
    <div className="relative h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      <Link
        ...
        className={cn(
          ...
          "absolute top-4 right-4 z-50 md:top-8 md:right-8 hover:bg-slate-100 dark:hover:bg-slate-800"
        )}
      >
        Login
      </Link>
      ...
      <div className="relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-10 mt-auto">
          <blockquote className="space-y-4">
            <p className="text-2xl font-medium leading-tight">AI-Powered Essay Feedback Platform</p>
            <p className="text-sm text-slate-400">
              Get instant, personalized feedback on your academic writing using advanced AI analysis.
            </p>
          </blockquote>
          {/* Feature bullets */}
