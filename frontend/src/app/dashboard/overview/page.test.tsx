...
describe('Dashboard Overview Page', () => {
  ...
  describe('Page Structure', () => {
    ...
    it('renders pending assignments message', () => {
      ...
      expect(screen.getByText(/2.*assignments pending/i)).toBeInTheDocument();
    });

    it('renders feedback notification message', () => {
      render(<DashboardPage />);

      expect(screen.getByText(/1.*new feedback/i)).toBeInTheDocument();
    });
  });
  ...
  describe('Tabs Navigation', () => {
    ...
    it('renders Overview tab content', () => {
      ...
      const overviewContent = screen.getByRole('tabpanel', {
        name: 'overview'
      });
  ...
  describe('Styling', () => {
    it('has welcome banner with correct styling', () => {
      ...
      const banner = screen
        .getByText(/Academic Command Center/i)
        .closest('div');
