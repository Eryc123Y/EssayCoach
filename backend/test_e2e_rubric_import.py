...
def test_pdf_extraction():
    ...
    if not pdf_path.exists():
        print(f"❌ FAIL: rubric.pdf not found at {pdf_path}")
        return False
    ...
    invalid_weights["dimensions"] = [
        {
            ...
            "weight": 40.0,
            "levels": [
                {"name": "Good", "score_min": 0, "score_max": 40, "description": "OK"}
            ],
        },
        {
            "name": "Organization",
...
def main():
    ...
    results.append(("PDF Text Extraction", test_pdf_extraction()))
    results.append(("Rubric Detection Logic", test_rubric_detection()))
