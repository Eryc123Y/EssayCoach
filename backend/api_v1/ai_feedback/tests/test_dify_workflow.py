...
from api_v1.ai_feedback.exceptions import APIServerError

if TYPE_CHECKING:
    from api_v1.core.models import User as CoreUser
else:
...
class WorkflowRunViewTests(DifyWorkflowAPITestCase):
    ...
    @patch("api_v1.ai_feedback.dify_client.DifyClient.build_rubric_input")
    @patch("api_v1.ai_feedback.dify_client.DifyClient.upload_file")
    @patch("api_v1.ai_feedback.dify_client.DifyClient.run_workflow")
    @patch("api_v1.ai_feedback.response_transformer.DifyResponseTransformer.to_workflow_output")
    def test_run_workflow_success(
        ...
        from api_v1.ai_feedback.interfaces import WorkflowStatus
    ...
    @patch("api_v1.ai_feedback.dify_client.DifyClient.analyze_essay")
...
class DifyWorkflowRunSerializerTests(TestCase):
    ...
    def test_serializer_valid_data(self):
        ...
        from api_v1.ai_feedback.serializers import DifyWorkflowRunSerializer
    ...
    def test_serializer_defaults(self):
        ...
        self.assertIn("response_mode", validated_data)
        self.assertIn("user_id", validated_data)
        self.assertEqual(validated_data.get("language"), "English")
        self.assertEqual(validated_data.get("response_mode"), "blocking")
        self.assertEqual(validated_data.get("user_id"), "essaycoach-service")
