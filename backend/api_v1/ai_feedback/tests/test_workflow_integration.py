...
from api_v1.core.models import MarkingRubric, RubricItem, RubricLevelDesc
...
class TestWorkflowIntegration(TestCase):
    ...
    def test_run_workflow_with_custom_rubric(
        ...
        from api_v1.ai_feedback.interfaces import WorkflowOutput, WorkflowStatus
    ...
    def test_run_workflow_with_missing_rubric(
        ...
        from api_v1.ai_feedback.exceptions import RubricError
        from api_v1.ai_feedback.interfaces import WorkflowOutput, WorkflowStatus
