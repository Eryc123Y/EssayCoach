...
_drf_serializer = getattr(WorkflowRunRequest, "drf_serializer", None)


class _DifyWorkflowRunSerializer(serializers.Serializer):
    """
...
if isinstance(_drf_serializer, type) and issubclass(_drf_serializer, serializers.Serializer):
    DifyWorkflowRunSerializer = _drf_serializer
else:
    DifyWorkflowRunSerializer = _DifyWorkflowRunSerializer

DifyWorkflowRunSerializer = cast(type[serializers.Serializer], DifyWorkflowRunSerializer)
